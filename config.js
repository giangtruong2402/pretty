const nameGirl = 'Pretty';
const giftUrl = '';
const eventName = 'Gửi em';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc em một ngày mới tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
